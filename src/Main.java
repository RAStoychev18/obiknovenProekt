...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("3. Print all medicines price and specific provider");
            System.out.println("4. Print all medicines imported from specific person");
    ...
    public static void printAllMedicinesWithPriceAndSpecificProvider(ArrayList<Pharmacy> pharmacies, Scanner sc) {
        ...
        System.out.println("Insert a manufacturer name: ");
    ...
    public static void printAllMedicinesWithSpecificImporter(ArrayList<Pharmacy> pharmacies, Scanner sc) {
        ...
        System.out.println();
        System.out.println("Insert a importer name: ");
        String name = sc.nextLine();
